                ...
                <div className="m-8">
                    ...
                    <div className="flex justify-between">
                        <div>
                            ...
                            <div className=" mt-2"><NotaQuadrada isStatic={1} /></div>
                        ...
                        <div>
                            ...
                            <div className="mt-11 "><NotaQuadrada isStatic={2} /></div>
                        ...
                        <div>
                            ...
                            <div className="mt-11"><NotaQuadrada isStatic={3} /></div>
                        ...
                        <div>
                            ...
                            <div className="mt-14"><NotaQuadrada isStatic={5} /></div>
