                ...
                <div className="m-8">
                    ...
                    <div className="flex justify-between">
                        <div>
                            ...
                            <div className=" mt-2"><NotaQuadrada nota={""} funcaoHandleNota={()=>{}} notasObject={{}} isStatic={1} /></div>
                        ...
                        <div>
                            ...
                            <div className="mt-11 "><NotaQuadrada nota={""} funcaoHandleNota={()=>{}} notasObject={{}} isStatic={2} /></div>
                        ...
                        <div>
                            ...
                            <div className="mt-11"><NotaQuadrada nota={""} funcaoHandleNota={()=>{}} notasObject={{}} isStatic={3} /></div>
                        ...
                        <div>
                            ...
                            <div className="mt-7"><NotaQuadrada nota={""} funcaoHandleNota={()=>{}}  notasObject={{}} isStatic={4} /></div>
                        ...
                        <div>
                            ...
                            <div className="mt-14"><NotaQuadrada nota={""} funcaoHandleNota={()=>{}}  notasObject={{}} isStatic={5} /></div>
