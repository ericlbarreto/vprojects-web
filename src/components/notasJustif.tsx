...
function NotasJustif({ text, textInfo, justif, funcaoJust, nota, funcaoHandleNota, notasObject, justifObject, isFinished }: NotaJustifProps) {
        ...
        <div className="mt-10">
            ...
            <div className="flex shadow rounded-sm w-80 h-10 pl-3 border text-sm">
                <div className="pt-3 flex">
                    <div>Nota:</div>
                    <div className="pt-0.5 pl-3"><NotaQuadrada nota={nota} funcaoHandleNota={funcaoHandleNota} notasObject={notasObject} isStatic={isFinished ? notasObject[nota] : 0} /></div>
                </div>
