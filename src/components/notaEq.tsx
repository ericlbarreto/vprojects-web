...
function NotaEq({ isNotaColab, nota, setNota, notasObject, isFinished}: NotaEqProps) {
    return (
        ...
        <div>{isNotaColab ?
            ...
            <div> 
                <div className="flex"> 
                    ...
                    <button onClick={() => !isFinished && setNota(nota, 3)} className={`border rounded w-4 text-center h-4 text-xs ${notasObject[nota]===3? "border-[#DFBC04] text-[#DFBC04] bg-[#FEFFC5]": notasObject[nota]===4?"border-[#8FE225] text-[#8FE225] bg-[#F1FFD3]": notasObject[nota]===5?"border-[#11D400] text-[#11D400] bg-[#DFFFDD]":"text-[#9F9F9F] border-[#C6C6C6]"}`}>3</button>
                    <button onClick={() => !isFinished && setNota(nota, 4)} className={`border rounded w-4 text-center h-4 text-xs ${notasObject[nota]===4? "border-[#8FE225] text-[#8FE225] bg-[#F1FFD3]": notasObject[nota]===5?"border-[#11D400] text-[#11D400] bg-[#DFFFDD]":"text-[#9F9F9F] border-[#C6C6C6]"}`}>4</button>
                    <button onClick={() => !isFinished && setNota(nota, 5)} className={`border rounded w-4 text-center h-4 text-xs ${notasObject[nota]===5? "border-[#11D400] text-[#11D400] bg-[#DFFFDD]":"text-[#9F9F9F] border-[#C6C6C6]"}`}>5</button>
                </div>
            </div>}
