...
const AtencaoModal = ({setAtencao, path}: AtencaoModalProps) => {
    ...
    return (
        <div className="flex-col z-50 fixed bg-branco w-80 h-52 p-4 border-2 shadow rounded-sm">
            ...
            <div className="text-black text-sm justify-center font-semibold flex mb-2">Atenção!</div>
            ...
            <div className="flex justify-center space-x-4">
                <button onClick={()=>setAtencao(false)} className="bg-[#EAEAEA] w-28 h-9 text-xs rounded-md text-black font-medium">Cancelar</button>
